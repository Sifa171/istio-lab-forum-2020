...
take a look at link:http://github.com/Sifa91/istio-lab-forum-2020/blob/master/src/istiofiles/recommendation_rate_limit.yml[recommendation_rate_limit.yml]
...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc create -f https://raw.githubusercontent.com/Sifa91/istio-lab-forum-2020/master/src/istiofiles/recommendation_rate_limit.yml
----
...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc delete -f https://raw.githubusercontent.com/Sifa91/istio-lab-forum-2020/master/src/istiofiles/recommendation_rate_limit.yml
----
