...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc -n user1-tutorial create -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-503.yml
----
...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc -n user1-tutorial delete -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-503.yml
----
...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc -n user1-tutorial create -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-delay.yml
----
...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc -n user1-tutorial delete -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-delay.yml
----
