...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc -n user1-tutorial get pods -l app=recommendation
----
...
take a look at link:http://github.com/Sifa91/istio-lab-forum-2020/blob/master/src/istiofiles/virtual-service-recommendation-503.yml[virtual-service-recommendation-503.yml]
...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc -n user1-tutorial create -f https://raw.githubusercontent.com/Sifa91/istio-lab-forum-2020/master/src/istiofiles/virtual-service-recommendation-503.yml
----
...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc -n user1-tutorial delete -f https://raw.githubusercontent.com/Sifa91/istio-lab-forum-2020/master/src/istiofiles/virtual-service-recommendation-503.yml
----
...
link:http://github.com/Sifa91/istio-lab-forum-2020/blob/master/src/istiofiles/virtual-service-recommendation-delay.yml[virtual-service-recommendation-delay.yml]
...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc -n user1-tutorial create -f https://raw.githubusercontent.com/Sifa91/istio-lab-forum-2020/master/src/istiofiles/virtual-service-recommendation-delay.yml
----
...
[NOTE]
====
Use `oc get pods -n user1-tutorial` to find the `recommendation` pods to look at the logs.
====

[source,bash,subs="+macros,+attributes",role="copypaste copypaste-warning"]
----
oc -n user1-tutorial logs -f recommendation-v#-XXXXXXXXXXXX -c recommendation
----
...
* Namespace: user1-tutorial
* Service: recommendation.user1-tutorial
...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc -n user1-tutorial delete -f https://raw.githubusercontent.com/Sifa91/istio-lab-forum-2020/master/src/istiofiles/virtual-service-recommendation-delay.yml
----
