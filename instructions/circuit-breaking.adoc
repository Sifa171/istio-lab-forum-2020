...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc -n user1-tutorial create -f  https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-timeout.yml
----
...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc -n user1-tutorial delete -f  https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-timeout.yml
----
...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc -n user1-tutorial apply -f  https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-split.yml
----
...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc apply -n user1-tutorial -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/destination-rule-recommendation_cb_policy_version_v2.yml
----
...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc -n user1-tutorial delete -f  https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-split.yml
----
