...
take a look at
link:http://github.com/Sifa91/istio-lab-forum-2020/blob/master/src/istiofiles/policy-jwt.yaml[policy-jwt.yaml]
...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc -n user1-tutorial create -f https://raw.githubusercontent.com/Sifa91/istio-lab-forum-2020/master/src/istiofiles/policy-jwt.yaml
----
...
link:http://github.com/Sifa91/istio-lab-forum-2020/blob/master/scripts/curl_customer_token.sh[curl_customer_token.sh]
...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
bash <(curl -s https://raw.githubusercontent.com/Sifa91/istio-lab-forum-2020/master/scripts/curl_customer_token.sh)
----
...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc -n user1-tutorial delete -f https://raw.githubusercontent.com/Sifa91/istio-lab-forum-2020/master/src/istiofiles/policy-jwt.yaml
----
...
link:http://github.com/Sifa91/istio-lab-forum-2020/blob/master/src/istiofiles/authorization-enable-rbac.yml[authorization-enable-rbac.yml]
...
[source, bash,subs="+macros,+attributes",role="copypaste"]
----
oc -n user1-tutorial create -f https://raw.githubusercontent.com/Sifa91/istio-lab-forum-2020/master/src/istiofiles/authorization-enable-rbac.yml
----
...
link:http://github.com/Sifa91/istio-lab-forum-2020/blob/master/src/istiofiles/namespace-rbac-policy.yml[namespace-rbac-policy.yml]
...
[source, bash,subs="+macros,+attributes",role="copypaste"]
----
oc -n user1-tutorial create -f https://raw.githubusercontent.com/Sifa91/istio-lab-forum-2020/master/src/istiofiles/namespace-rbac-policy.yml
----
...
[source,bash,subs="+macros,+attributes",role="copypaste"]
----
oc -n user1-tutorial delete -f https://raw.githubusercontent.com/Sifa91/istio-lab-forum-2020/master/src/istiofiles/namespace-rbac-policy.yml
oc -n user1-tutorial delete -f https://raw.githubusercontent.com/Sifa91/istio-lab-forum-2020/master/src/istiofiles/authorization-enable-rbac.yml
----
